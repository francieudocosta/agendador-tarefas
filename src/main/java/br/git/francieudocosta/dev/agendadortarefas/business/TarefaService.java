...
import br.git.francieudocosta.dev.agendadortarefas.business.mapper.TarefaUpdateConverter;
...
import br.git.francieudocosta.dev.agendadortarefas.infrastructure.exceptions.ResourceNotFoundException;
...
public class TarefaService {
    ...
    public void deletarTarefaPorId(String id) {
        ...
        try{
            ...
            throw new ResourceNotFoundException("Erro ao deletar tarefa com id " + id, e.getCause());
        }
    }
    ...
    public TarefasDTO alteraStatus(StatusNotificacaoEnum status, String id){
        ...
        try{
            ...
            entity.setStatusNoficacao(status);
    ...
    public TarefasDTO updateTarefas(TarefasDTO dto, String id){
        ...
        try{
            ...
            throw new ResourceNotFoundException("Erro ao alterar atualizar " + id, e.getCause());
        }
    }
